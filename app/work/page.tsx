    ...
    <main className="min-h-screen bg-black text-white flex flex-col">
      ...
      <section className="w-full border-b border-neutral-800 bg-black">
        <div className="mx-auto max-w-7xl px-6 py-10 md:py-16 grid md:grid-cols-5 gap-10 items-center">
          ...
          <div className="md:col-span-2">
            <div className="relative w-full overflow-hidden rounded-2xl border border-neutral-800 aspect-[16/10] md:aspect-[4/3]">
              <Image
                src="/work-hero.png"
                alt="Project collage"
                fill
      ...
      <section className="w-full bg-black border-b border-neutral-800">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-0">
          {projects.map((p) => (
            <article key={p.src} className="group relative aspect-[16/9] overflow-hidden border-r border-b border-neutral-800">
              <Image
                src={p.src}
                alt={p.title}
                fill
              ...
              <div className="absolute left-4 bottom-3 z-10">
                <span className="inline-flex items-center gap-2 rounded-full border border-cyan-500/30 bg-black/60 px-2.5 py-1 text-[11px] text-cyan-200">
                  {p.tag}
                </span>
      ...
      <section className="w-full border-b border-neutral-800 bg-black">
        <div className="mx-auto max-w-7xl px-6 py-12 md:py-16 grid md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div className="relative w-full overflow-hidden rounded-2xl border border-neutral-800 aspect-[16/9]">
            <Image
          ...
          <div>
            <p className="text-xs tracking-widest text-cyan-400 uppercase mb-2">Case study</p>
            ...
            <ul className="mt-4 grid grid-cols-2 gap-3 text-sm text-neutral-300">
              <li className="rounded-xl border border-neutral-800 bg-neutral-950 px-3 py-2">UX/UI & IA</li>
              <li className="rounded-xl border border-neutral-800 bg-neutral-950 px-3 py-2">Next.js + CMS</li>
              <li className="rounded-xl border border-neutral-800 bg-neutral-950 px-3 py-2">Performance</li>
              <li className="rounded-xl border border-neutral-800 bg-neutral-950 px-3 py-2">SEO & Analytics</li>
            </ul>
            <div className="mt-6 flex gap-3">
              <Link
                href="/contact"
